...
RUN apt-get update -y && apt-get -y install zip python3-pip vim locales netcat-openbsd && rm -rf /var/lib/apt/lists/* && localedef -i zh_CN -c -f UTF-8 -A /usr/share/locale/locale.alias zh_CN.UTF-8
